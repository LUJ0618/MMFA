    ...
    def __getitem__(self, indices):
        ...
        for index in indices:
            try:
                ...
                print(f"예외 이름: {type(e).__name__}")  # 예외의 이름 출력
                print(f"예외 메시지: {e}")  
...
if __name__ == '__main__':
    ...
    # 데이터셋 로드
    train_dataset = train_dataset_loader(train_list='../dataset/speaker_verification/voxceleb2_train.txt', 
                                          augment=True, 
                                          musan_path='../dataset/speaker_verification/musan/', 
                                          rir_path='../dataset/speaker_verification/rirs_noises/RIRS_NOISES/simulated_rirs/', 
                                          max_frames=300, 
                                          train_path='../dataset/speaker_verification/voxceleb2/',
                                          )
    ...
    for index in range(len(train_dataset)):
        label = train_dataset.data_label[index]  # 레이블 가져오기
